      ...
      <div className="wrapper bg-lightgrey mx-16 lg:mx-8 mt-20">
        ...
        <div className="image-wrapper">
          ...
          <Link className="box4 relative overflow-hidden group" to="/">
              ...
              <div className="content-body h-[100%] w-[100%] absolute top-0  -left-[100%]  bg-[#1f3d4738] backdrop-blur-sm rounded-md text-lg p-7 lg:p-2 leading-8 lg:leading-6 group-hover:left-0 duration-700">
            ...
            <Link className="box4 relative overflow-hidden group" to="/product">
              <img src="images/pot1.webp" alt="img" className="rounded-md" />
              <div className="content-body h-[100%] w-[100%] absolute top-0  -left-[100%]  bg-[#1f3d4738] backdrop-blur-sm rounded-md text-lg p-7 lg:p-2 leading-8 lg:leading-6 group-hover:left-0 duration-700">
                <div className="content-title text-2xl lg:text-lg font-bold mb-3">
                  Acoustic Guitar
        ...
        <div className="see-more mt-5 text-sky-800 text-xl">
          <Link to="/womenfashion" className="hover:text-pink ">
            Explore Now
          </Link>
        </div>
      </div>
